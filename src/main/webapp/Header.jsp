...
<!-- 로고 이미지 -->
	...
	<a href="categoryCon?product=mouse"><button class="header_menu">카테고리</button></a> 
...
<script language="javascript">
    function showPopup() { window.open("AskCenter.html", "a", "width=600, height=700, left=100, top=50"); }
</script>
<%} else if(info==null && adinfo==null) {%>
<a href="http://pf.kakao.com/_xhHADK" class="linktab">
<div class="sidemenu_kakao">
