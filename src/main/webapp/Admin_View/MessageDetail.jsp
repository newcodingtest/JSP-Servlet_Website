...
%>
    ...
    <tr>
        ...
        <td class="article" height=50px>제목</td>
    </tr>
    <tr>
        <td class="title">작성자</td><td>작성자</td>
    </tr>
    <tr>
        <td class="title">작성시간</td>
        <td class="article" height=50px>작성시간</td>
    </tr>
    <tr >
      ...
      <tr >
        ...
        <td class="article" height=200px>작성시간</td>
    </tr>
   
    </table>
 
	<br>
    <a href="update.jsp?comid=${bean.comid}" class="btn btn-default">수정</a> <br>
    <a href="delete?comid=${bean.comid}" class="btn btn-default">삭제</a> <br>
