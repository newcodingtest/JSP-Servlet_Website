...
<!------------------------------ ▲ 카테고리 메뉴 ▲ ------------------------------>
    ...
    <div class="sort-items">
       <a href="낮은가격">낮은가격</a>
        <a href="높은가격">높은가격</a>
          <input type="text" name="return" id="money" value="원"> ~
			<input type="text" name="return" id="money" value="원">
			 <input type="button" name="return" id="search" value="검색">
	        	<select name="count">
	...
	<input type="hidden" id="detail_5" name="fifth" value="null">
                ...
                <span>CPU 제조사</span>   
				<select name="first"><option value="null" selected="selected">CPU 제조사 선택</option>
				<option value="intel">인텔</option><option value="amd">암드</option>
                </select>
  
                <span>코어 수</span>
                <select name="second">
					<option value="null" selected="selected">코어 구분</option>
					<option value="8">8코어</option><option value="4">4코어</option><option value="16">16코어</option>
                </select>

                <span>Intel 소켓</span>
                <select name="third">
  					<option value="null" selected="selected">인텔 소켓 구분</option>
	...
	<input type="hidden" id ="detail_5" name="detail_5" value="form">
                ...
                <span>칩셋 제조사</span>   
				<select name="first">
					<option value="null" selected="selected">칩셋 제조사 선택</option>
					<option value="Intel">인텔</option><option value="AMD">AMD</option>
                </select>
  
                <span>메인보드 제조사</span>
                <select name="second">
					<option value="null" selected="selected">메인보드 제조사 선택</option>
                ...
                <span>소켓</span>
                <select name="fourth">
					<option value="null" selected="selected">소켓 구분</option>
                ...
                <span>폼팩터</span>
                <select name="fifth">
					<option value="null" selected="selected">폽팩터 구분</option>
	...
	<input type="hidden" id="detail_5" name="fifth" value="null">
                ...
                <span>메모리 타입</span>
                <select name="second">
					<option value="null" selected="selected">메모리 타입 선택</option>
					<option value="DDR4">DDR4</option><option value="DDR3">DDR3</option>
                </select>

                <span>용량</span>
                <select name="third">
  					<option value="null" selected="selected">메모리 용량 선택</option>
      				<option value="8GB">8GB</option><option value="16GB">16GB</option><option value="32GB">32GB</option>
                </select>
	
                <span>클럭</span>
                <select name="fourth">
					<option value="null" selected="selected">메모리 클럭 선택</option>
	...
	<input type="hidden" id="detail_5" name="fifth" value="null">
                ...
                <span>제조사</span>
                <select name="second">
					<option value="null" selected="selected">그래픽 카드 제조사 선택</option>
